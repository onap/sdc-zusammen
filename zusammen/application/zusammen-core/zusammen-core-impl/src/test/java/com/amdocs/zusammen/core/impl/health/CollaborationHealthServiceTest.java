...
public class CollaborationHealthServiceTest {

    private static final SessionContext CONTEXT = TestUtils
            .createSessionContext(new UserInfo("CollaborationHealthServiceTest_user"), "test");
    ...
    private CollaborationHealthService service;

    @BeforeMethod
    public void setUp() {
        mocks = MockitoAnnotations.openMocks(this);
        service = new CollaborationHealthService();
    }
    ...
    public void testHealthStatusComesFromTheMatchingAdaptorCall() {
        ...
        Assert.assertSame(healthInfos.iterator().next(), COLLABORATION_STATUS);
    }
