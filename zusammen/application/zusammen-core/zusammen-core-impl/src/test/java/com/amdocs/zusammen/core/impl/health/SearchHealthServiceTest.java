...
public class SearchHealthServiceTest {

    private static final SessionContext CONTEXT = TestUtils
            .createSessionContext(new UserInfo("SearchHealthServiceTest_user"), "test");
    ...
    private SearchHealthService service;

    @BeforeMethod
    public void setUp() {
        mocks = MockitoAnnotations.openMocks(this);
        service = new SearchHealthService();
    }
    ...
    public void testHealthStatusComesFromTheMatchingAdaptorCall() {
        ...
        Assert.assertSame(healthInfos.iterator().next(), SEARCH_STATUS);
    }
