...
public class HealthAdaptorFactoryImplTest {
    ...
    public void testCreateInterfaceReturnsTheSameAdaptorForEveryContext() {
        HealthAdaptorFactoryImpl factory = new HealthAdaptorFactoryImpl();

        HealthAdaptor first = factory.createInterface(sessionContext("user-1"));
        HealthAdaptor second = factory.createInterface(sessionContext("user-2"));
    ...
    private static SessionContext sessionContext(String userName) {
