...
public class AbstractFactoryTest {
    ...
    public abstract static class GreeterFactory extends AbstractFactory<String> {
    ...
    @Test
    public void testConcreteFactoryIsResolvedThroughTheSharedRegistry() {
        ...
        Assert.assertEquals(factory.createInterface(), "greeter");
